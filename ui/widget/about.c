...
int widget_about_draw(void *data GCC_UNUSED)
{
    ...
    widget_printstring(x, ((++line * 8) + 24), WIDGET_COLOUR_FOREGROUND, "the Free Unix Spectrum Emulator (Fuse)");
    ...
    x = margin - 8 + ((dialog_cols * 8) - string_width) / 2;
    widget_printstring(x, ((++line * 8) + 24), WIDGET_COLOUR_FOREGROUND, FUSE_COPYRIGHT);
